...
→ <https://github.com/dogeshitmeme/dogeshit-wallet/security/advisories/new>
...
Only the latest published release receives security fixes. There is no LTS branch — upgrade to the latest version from the [Chrome Web Store](https://chromewebstore.google.com/detail/dogeshit-wallet/epbdphmhjbjiemaeabfkghhopangghli) or the latest [GitHub Release](https://github.com/dogeshitmeme/dogeshit-wallet/releases).
...
- The privacy policy at <https://wallet.dogeshit.meme/privacy>
