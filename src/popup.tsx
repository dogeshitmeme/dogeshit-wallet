    ...
    switch (screen.name) {
      ...
      case 'settings':      return <Settings
                              ...
                              onLock={async () => {
                                ...
                                showToast({ tone: 'green', icon: '🔒', text: 'wallet locked. much safe.' });
                                route();
                              }}
      ...
      case 'reset-confirm': return <ResetConfirm
                              ...
                              onDone={async () => {
                                ...
                                showToast({ tone: 'red', icon: '🗑', text: 'wallet wiped. much fresh start.' });
                                route();
                              }}
                            />;
  ...
  return (
    <ToastContext.Provider value={showToast}>
      <NetworkProvider>
        {renderScreen()}
        {toast && (
          <div key={toast.id} className={'dk-toast ' + (toast.tone ?? 'yellow')}>
