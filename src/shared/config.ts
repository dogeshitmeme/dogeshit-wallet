...
// chain choice via getCurrentChainId() in core/storage.ts. Changed
// sepolia → mainnet so new installs land on the network real funds live
// on (cleaner first impression than a testnet pill on the dashboard).
...
export const WALLET_INFO = {
  uuid: 'a1b2c3d4-dogeshit-wallet-8f0c-000000000001',
  name: 'Dogeshit Wallet',
  icon: ICON_DATA_URL,
  rdns: 'meme.dogeshit.wallet',
} as const;
