...
// (`dk-alert dk-alert-danger`, `dk-alert`) — no new CSS surface
...
const SEVERITY_CLASS: Record<Severity, string> = {
  danger: 'dk-alert dk-alert-danger',
  warning: 'dk-alert',
  info: 'dk-alert',
  safe: 'dk-alert',
};
...
export function SecurityChecks({ signals }: { signals: readonly Signal[] }) {
  ...
  // dk-big-banner). Rendering them here would duplicate the warning.
  ...
  return (
    <div className="dk-security-checks">
      {sorted.map((s) => (
