...
// 4269 — meme-adjacent to the project's brand port 42069 (mainnet
// backend default). Coincidence-free vs. 4318 (the previous pick,
// which collides with OpenTelemetry OTLP/HTTP if a local collector
// is running).
